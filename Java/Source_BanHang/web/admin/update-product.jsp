<%-- 
    ...
    Created on : Oct 20, 2019, 12:12:39 AM
    Author     : PC
--%>
...
<html>
    ...
    <body>
        ...
        <form action = "UploadFile.jsp" method = "post"
         ...
         <br /> <br/>
         <input style="padding: 5px;" type = "submit" value = "Upload File" /> <br/>
        </form>
        <%
        ...
        <form action="../ProductController" method="get">
            ...
            Note: <input type="text" name="note" value="<%= product.getNote() %>" /><br/>
            ...
            <center><input type="submit" name="_type" value="EXE_UPDATE"/>
            <input type="hidden" name="id" value="<%= product.getId() %>" /></center>
        </form>
        </div>
                <!-----------------nội dung ----------->
            </div>
