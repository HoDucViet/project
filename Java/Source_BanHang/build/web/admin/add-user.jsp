<%-- 
    Document   : add-user
    Created on : Oct 20, 2019, 12:11:12 AM
    Author     : PC
--%>
        ...
        <div class="container">
            ...
            <article>
                ...
                <div class="tranggiohang">
                        <%
            User user6=(User)session.getAttribute("userlogined");
            if(user6==null)
            ...
            <div class="w3layoutscontaineragileits" style="margin-top: 20px;">
                ...
                <form action="../UserController" method="get">
                    ...
                    <center> <div class="rdo" style="font-weight: bold; color: #FF0033">
                    Role<br/>
                    <p style="font-weight: bold; color: #333399">
                          <input type="radio" name="role" value="1" />Admin
                    <input type="radio" name="role" value="0" />User <p>
                          <div/>
