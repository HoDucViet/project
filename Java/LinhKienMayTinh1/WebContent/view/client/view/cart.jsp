        ...
        <ul class="list-unstyled badge-open mCustomScrollbar"
            ...
            <c:forEach items="${sessionScope.cart}" var="map">
                <li><c:url value="/Images/${map.value.product.image }"
                    ...
                    <div class="overflow-h">
                        ...
                        <small>${map.value.quantity} * <fmt:formatNumber value="${map.value.product.price}" pattern="#,##0" /> đ</small>
                    </div>
            ...
            <li class="subtotal">
                <div class="overflow-h margin-bottom-10">
                    ...
                    <span class="pull-right subtotal-cost">đ <fmt:formatNumber value="${total}" pattern="#,##0" /></span>
