        ...
        <div class="wrapper">
            ...
            <div class="header-v5 header-${url}">
                ...
                <div class="breadcrumbs-v4">
                    <div class="container">
                        <h1>
                            VIỆT<span class="shop-green">COMPUTER</span>
                        </h1>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 md-margin-bottom-50">
                            <h2 class="text-uppercase">Chào mừng đến với <span class="text-primary">VIỆT COMPUTER</span></h2>
                            <h1 class="welcome-title">Cửa hàng linh kiện thiết bị máy tính cao cấp</h1>
                        </div>
