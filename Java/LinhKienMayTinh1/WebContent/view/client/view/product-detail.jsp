                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-inline product-ratings margin-bottom-30">
                                ...
                                <li class="product-review-list"><span>(1) <a href="#">Review</a> | <a href="#"> Add Review</a></span></li>
                            </ul>
                            <!--/end shop product ratings-->
                            ${product.des} <br>
                           <ul class="list-inline shop-product-prices margin-bottom-30">
    <li class="shop-red" id="currentPrice">đ <fmt:formatNumber value="${product.price}" pattern="#,##0" /></li>
    <li class="line-through"><fmt:formatNumber value="${product.price * 1.25}" pattern="#,##0" /></li>
    <li><small class="shop-bg-red time-day-left"> Best Sale </small></li>
</ul>

<h3 class="shop-product-title">Số lượng</h3>
<div class="margin-bottom-40">
    <form name="f1" class="product-quantity sm-margin-bottom-20" method="get" action="<c:url value="/member/cart/add"></c:url>">
        <input type="text" value="${product.id}" name="pId" hidden="">
        <button type="button" class="quantity-button" name="subtract" onclick="changeQty(-1)">-</button>
        <input type="text" class="quantity-field" name="quantity" value="1" id="qty" onchange="updatePrice()" />
        <button type="button" class="quantity-button" name="add" onclick="changeQty(1)">+</button>
...
<script>
   ...
   function updatePrice() {
    ...
    // Hiển thị giá tiền mới trong thẻ ul
    document.getElementById("currentPrice").innerText = "đ " + formattedPrice;
}
